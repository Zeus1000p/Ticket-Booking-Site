    ...
    <div class="w-dyn-items"><div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">James Concert at Mumbai</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">NobelMan Concert at San Francisco</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Lalon Band Concert at San Diego-Chula Vista</div>
            </div>
            <div class="w-col w-col-3">
          ...
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">James Concert at San Jose-Sunnyvale</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Avash Concert</div>
            </div>
            <div class="w-col w-col-3">
              <div>New Orleans</div>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Avash concert at Las Vegas</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">NobelMan Concert at Vancouver</div>
            </div>
            <div class="w-col w-col-3">
              <div>Vancouver, Oregon</div>
            </div>
            <div class="w-col w-col-2">
              <button class="rsvp-button w-button" onclick="op()">Buy Tickets</button>
            </div>
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Warfaze Concert at Denver</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Lalon Band Concert at Nashville</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Delta Concert</div>
            </div>
            <div class="w-col w-col-3">
        ...
        <div class="venue-list-item w-dyn-item">
          <div class="tour-date-row w-row">
            ...
            <div class="w-col w-col-5">
              <div class="venue">Riverfront concert at Miami</div>
            </div>
            <div class="w-col w-col-3">
